...
class TestPriceCalculator:
    ...
    def test_over_thirty_minutes(self, price_calculator):
        assert price_calculator.calculate_fee(90, 0) == 6.0
        assert price_calculator.calculate_fee(90, 1) == 5.0
        assert price_calculator.calculate_fee(90, 2) == 4.0
        assert price_calculator.calculate_fee(90, 3) == 3.0
        assert price_calculator.calculate_fee(90, 4) == 2.0
